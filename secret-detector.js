...
function saveSecretsToFile(secretItems, filePath) {
  const formattedSecrets = secretItems.map(mapToSecretFormat);
  fs.writeFileSync(filePath, JSON.stringify(formattedSecrets, null, 2));
